<?php
    ...
    $requirements = array_filter(preg_split('/;|,/', $req_post), fn($r) => trim($r) !== '');
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $_SESSION['add_job_successful'] = true;
        header("Location: success_process_job.php?refnum=" . urlencode($reference_number));
        exit();
    } else {
