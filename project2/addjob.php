        ...
        <div class="form-wrapper">
            <form class="application-form" action="processjob.php" method="post" novalidate="novalidate">
                ...
                <div class="input-block">
                    ...
                    placeholder="Enter Reference Number"  title="Reference number should be two letter follow up by 4 to 9 numbers." required>
                <div class="input-block">
                    <!-- job title -->
                    <label for="job_title">Email</label>
                    <input type="text" id="job_title" name="job_title" placeholder="Enter the job title"
                        required>
                </div>
                <div class="input-block">
                    <!-- location -->
                ...
                <div class="input-block">
                    ...
                    <textarea id="job_desc" name="job_desc" rows="4" cols="40"
                ...
                <div class="input-block">
                    ...
                    placeholder="Enter Salary Range" title="Format: $140,000-$200,000" required>
                </div>
                <div class="input-block">
                    <!-- Hours -->
                    <label for="hours">Hours and Employment Type</label>
                    <input type="text" id="hours" name="hours"
                    placeholder="Enter Employment Type and Working Hours per week" title="Format: Full-Time, 38-40 hours/week" required>
                </div>
                <div class="input-block">
                    <!-- Reports -->
                    <label for="reports">Person In Charge</label>
                    <input type="text" id="reports" name="reports"
                    placeholder="Enter the Person In Charge" required>
                </div>
                <div class="input-block">
                    <!-- Requirements -->
                    <label for="requirements">Requirement</label>
                    <textarea id="requirements" name="requirements" rows="4" cols="40"
                        placeholder="Enter Requirements, separate using (;) or (,)" title="Format: Good at Python; Great Communication Skill" required></textarea>
                </div>
                <div class="input-block">
